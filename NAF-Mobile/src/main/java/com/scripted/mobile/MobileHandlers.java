...
public class MobileHandlers {
	...
	public static void scrollToEndOfPage(){
		new TouchAction(MobileDriverSettings.getCurrentDriver()).press(PointOption.point(550, 640)).waitAction().moveTo(PointOption.point(550, 60)).release().perform();
	}

	public static void scrollAndClickByText(String visibleText) {
		scrollAndClickByText(visibleText, true);
	}

	public static void scrollAndClickByText(String visibleText, boolean contains) {
		if (contains) {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"" + visibleText + "\").instance(0))")).click();
		} else {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().text(\"" + visibleText + "\").instance(0))")).click();
		}
	}

	public static void scrollByContentDesc(String contdesc, boolean contains) {
		if (contains) {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().className(\"android.view.ViewGroup\").descriptionContains(\"" + contdesc + "\").instance(0))"));
		} else {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().description(\"" + contdesc + "\").instance(0))"));
		}
	}

	public static void scrollAndClickByContentDesc(String contdesc) {
		scrollAndClickByText(contdesc, true);
	}

	public static void scrollAndClickByContentDesc(String contdesc, boolean contains) {
		if (contains) {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().className(\"android.view.ViewGroup\").descriptionContains(\"" + contdesc + "\").instance(0))")).click();
		} else {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().description(\"" + contdesc + "\").instance(0))")).click();
		}
	}

	public static void scrollAndClickById(String id) {
		scrollAndClickByText(id, true);
	}

	public static void scrollAndClickById(String id, boolean contains) {
		if (contains) {
			//.className("android.view.ViewGroup")
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().resourceIdContains(\"" + id + "\").instance(0))")).click();
		} else {
			MobileDriverSettings.getCurrentDriver().findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().resourceId(\"" + id + "\").instance(0))")).click();
		}
	}
	...
	public static void scrollAndClick(MobileElement locator, String scrollType) {
		try {
			...
			LOGGER.error("Error occurred while trying to scroll and click the locator: " + locator + "Exception :" + e);
			Assert.fail("Error  occurred while trying to scroll and click the locator:" + locator + "Exception :" + e);
		}
	}
	...
	public static boolean dropDownSetByVal(MobileElement locator, String value) {
		...
		try {
			...
			LOGGER.error("Error while performing the dropDownSetByVal action for the locator: " + locator
					+ "Exception :" + e);
			Assert.fail("Error while performing the dropDownSetByVal action for the locator: " + locator + "Exception :"
					+ e);
		}
		return flag;
	}
	...
	public static boolean objExists(MobileElement locator) {
		{
			boolean eFlag = false;
			try {
	...
	/*
	 * public static void objExists(MobileElement locator) { try { By byEle =
	 * MobileHandlers.mobileElementBy(locator);
	 * LOGGER.info("objExists check completed successfully, Object exists "); }
	 * catch (Exception e) { e.printStackTrace();
	 * LOGGER.error("Error occurred while checking whether the object exists " +
	 * "Exception :" + e);
