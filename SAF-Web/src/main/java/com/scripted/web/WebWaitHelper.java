...
public class WebWaitHelper {
		...
		new FluentWait<WebDriver>(BrowserDriver.getDriver()).withTimeout(getElementWaitTimeoutInDuration())
				...
				.until(new Function<WebDriver, Boolean>() {
					...
					public Boolean apply(WebDriver d) {
						try {
							//System.out.println(" Fluent wait before clicking");
							...
							flag = true;
							//System.out.println(" Fluent wait after clicking");
						} catch (Exception e) {
							e.printStackTrace();
							LOGGER.error("Error occurred while waiting for loading the locator :" +webEle +"Exception :"+e);
							String err=BrowserDriver.getPopup("Error occurred while waiting for loading the locator:" +webEle);
				...
				.until(new Function<WebDriver, Boolean>() {
					...
					public Boolean apply(WebDriver d) {
						try {
							...
							String err=BrowserDriver.getPopup("Error occurred while performing  waitForClear action for  locator:" +webEle);
							JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
							js.executeScript(err);
				...
				.until(new Function<WebDriver, Boolean>() {
					...
					public Boolean apply(WebDriver d) {
						try {
							...
							String err=BrowserDriver.getPopup("Error occurred while performing  waitForPresence action for  locator:" +webEle);
							JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
							js.executeScript(err);
	...
	public static void waitForPresence(By byEle, int time) {
		try
		{
		WebDriverWait wait = new WebDriverWait(BrowserDriver.getDriver(), time, 40);
		...
		catch(Exception e)
		{
			...
			String err=BrowserDriver.getPopup("Error occurred while performing  waitForPresence action for  locator:" +byEle);
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
			js.executeScript(err);
	...
	public static void waitForClickable(By byEle, int time) {
		...
		catch(Exception e)
		{
			...
			String err=BrowserDriver.getPopup("Error occurred while performing  waitForClickable action for  locator:" +byEle);
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
			js.executeScript(err);
	...
	public static void waitForVisibleble(By byEle, int time) {
		...
		catch(Exception e)
		{
			...
			String err=BrowserDriver.getPopup("Error occurred while performing  waitForVisibleble action for  locator:" +byEle);
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
			js.executeScript(err);
	...
	public static void waitForNotStale(By byEle, int time) {
		...
		catch(Exception e)
		{
			...
			String err=BrowserDriver.getPopup("Error occurred while performing  waitForNotStale action for  locator:" +byEle);
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
			js.executeScript(err);
	...
	public static void scrollToElement(By locator) {
		...
		catch(Exception e)
		{
			...
			String err=BrowserDriver.getPopup("Error occurred while performing  scrollToElement action for  locator:" +locator);
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
			js.executeScript(err);
	...
	public static void scrollToElement(WebElement element) {
		...
		{
			e.printStackTrace();
			LOGGER.error("Error occurred while performing  scrollToElement action for locator :" + element +"Exception :"+e);
			String err=BrowserDriver.getPopup("Error occurred while performing  scrollToElement action for locator :" + element);
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();
			js.executeScript(err);
			Assert.fail("Error occurred while performing  scrollToElement action for locator :" + element +"Exception :"+e);
		}
	}
	...
	public static void waitForClear(By by, int time) {
		...
		catch(Exception e)
		{
			...
			String err=BrowserDriver.getPopup("Error occurred while performing  waitForClear action");
			JavascriptExecutor js = (JavascriptExecutor) BrowserDriver.getDriver();	
			js.executeScript(err);
